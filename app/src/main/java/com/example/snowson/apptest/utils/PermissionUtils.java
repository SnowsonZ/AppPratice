...
public class PermissionUtils {
    ...
    public static List<String> getPermissions() {
        return getPermissions(BlackJUtil.getApp().getPackageName());
    }
    ...
    public static List<String> getPermissions(final String packageName) {
        PackageManager pm = BlackJUtil.getApp().getPackageManager();
        try {
    ...
    private static boolean isGranted(final String permission) {
        return Build.VERSION.SDK_INT < Build.VERSION_CODES.M
                ...
                == ContextCompat.checkSelfPermission(BlackJUtil.getApp(), permission);
    }
    ...
    public static void openAppSettings() {
        ...
        intent.setData(Uri.parse("package:" + BlackJUtil.getApp().getPackageName()));
        BlackJUtil.getApp().startActivity(intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK));
    }
    ...
    private void startPermissionActivity() {
        ...
        PermissionActivity.start(BlackJUtil.getApp());
    }
